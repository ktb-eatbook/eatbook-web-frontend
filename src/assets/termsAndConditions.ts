...
제 1조（목적）
Eatbook（이하 ‘회사'라고 함）는 회사가 제공하고자 하는 서비스（이하 ‘회사 서비스’）를 이용하는 개인
...
있습니다.
제3조（본 방침의 공개）
1. 2. 회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 회사 홈페이지 첫 화면 또는 첫 화면과의 연
결화면을 통해 본 방침을 공개하고 있습니다.
회사는 제 1항에 따라 본 방침을 공개하는 경우 글자 크기，색상 등을 활용하여 이용자가 본 방침을 쉽게 확
인할 수 있도록 합니다.
제4조（본 방침의 변경）
1. 2. 3. 본 방침은 개인정보 관련 법령，지침，고시 또는 정부나 회사 서비스의 정책이나 내용의 변경에 따라 개정
될 수 있습니다.
...
1. 필수수집 정보: 이메일 주소，닉네임 및 생년월일
2. 선택수집 정보: 프로필 이미지，성별
제6조（본인 인증을 위한 정보）
회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.
1. 필수 수집 정보: 이메일주소
제7조（회사 서비스 제공을 위한 정보）
회사는 이용자에게 회사의 서 비스를 제공하기 위하여 다음과 같은 정보를 수집합니 다.
1. 필수 수집 정보: 생년월일
2. 선택 수집 정보: 성별，활동 기록
제8조（서비스 이용 및 부정 이용 확인을 위한 정보）
회사는 이용자의 서비스 이용에 따른 통계 •분석 및 부정이용의 확인•분석을 위하여 다음과 같은 정보
를 수집합니다. （부정이용이란 회원탈퇴 후 재가입，상품구매 후 구매취소 등을 반복적으로 행하는 등
회사가 제공하는 할인쿠폰，이벤트 혜택 등의 경제상 이익을 불•편법적으로 수취하는 행위，이용약관 등
에서 금지하고 있는 행위，명의도용 등의 불•편법행위 등을 말합니다.）
1. 필수 수집 정보: 쿠키
제9조（개인정보 수집 방법）
회사는 다음과 같은 방법으로 이용자의 개인정보를 수집합니다.
1. 2. 3. 이용자가 회사의 홈페이지에 자신의 개인정보를 입력하는 방식
어플리케이션 등 회사가 제공하는 홈페이지 외의 서비스를 통해 이용자가 자신의 개인정보를 입력하는 방
식
이용자가 고객센터의 상담，게시판에서의 활동 등 회사의 서비스를 이용하는 과정에서 이용자가 입력하
는 방식
제10조（개인정보의 이용）
회사는 개인정보를 다음 각 호의 경우에 이용합니다.
1. 공지사항의 전달 등 회사운영에 필요한 경우
2. 이용문의에 대한회신，불만의 처리 등 이용자에 대한 서비스 개선을위한 경우
3. 회사의 서비스를 제공하기 위한 경우
4. 법령 및 회사약관을위반하는회원에 대한이용제한조치，부정 이용행위를포함하여 서비스의 원활한
...
2. 이용합니다.
전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정 가입 및 이용 방지를 위하여 회 원
탈퇴 시점으로부터 최대 5년간 보관합니다.
제12조（법령에 따른 개인정보의 보유 및 이용기간）
회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.
1. 2. 3. 전자상거래 등에서의 소비자보호에 관한 법률에 따른 보유정보 및 보유기간
...
제16조（광고성 정보의 전송 조치）
1. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 이용자의 명시적인 사전동 의를
받습니다. 다만，다음 각호 어느 하나에 해당하는 경우에는 사전 동의를 받지 않습니다
가. 회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한 경우，거래가 종료된 날로
부터 6개월 이내에 회사가 처리하고 수신자와 거래한 것과 동종의 재화 등에 대한 영리목적의 광고
성 정보를 전송하려는 경우
나.
「방문판매 등에 관한 법률」에 따른 전화권유판매자가 육성으로 수신자에게 개인정보의 수집출처
2. 3. 4. 5. 를 고지하고 전화권유를 하는 경우
회사는 전항에도 불구하고 수신자가 수신거부의사를 표시하거나 사전 동의를 철회한 경우에는 영리목적
의 광고성 정보를 전송하지 않으며 수신거부 및 수신동의 철회에 대한 처리 결과를 알립니다.
회사는 오후 9시부터 그다음 날 오전 8시까지의 시간에 전자적 전송매체를 이용하여 영리목적의 광고성
정보를 전송하는 경우에는 제 1항에도 불구하고 그 수신자로부터 별도의 사전 동의를 받습니다.
회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음의 사항 등을 광고성
정보에 구체적으로 밝힙니다.
가. 회사명및연락처
나. 수신 거부 또는 수신 동의의 철회 의사표시에 관한 사항의 표시
회사는 전자적 전송매체를 이용하여 영 리목적의 광고성 정보를 전송하는 경우 다음 각 호의 어느 하나에
해 당하는 조치 를 하지 않습니 다.
...
제17조（이용자의 의무）
1. 2. 3. 이용자는 자신의 개인정보를 최신의 상태로 유지해야 하며，이용자의 부정확한 정보 입력으로 발생하는
문제의 책임은 이용자 자신에게 있습니다.
타인의 개인정보를 도용한 회원가입의 경우 이용자 자격을 상실하거나 관련 개인정보보호 법령에 의해 처
벌받을 수 있습니다.
이용자는 전자우편주소，비밀번호 등에 대한 보안을 유지할책임이 있으며 제3자에게 이를 양도하거나대
여할 수 없습니다.
...
1. 회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정 보
자동 수집장치（이하 '쿠키’）를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용 자의
웹브라우저(PC 및 모바일을 포함）에게 보내는 소량의 정보이며 이용자의 저장공간에 저장되기도합 니다.
2. 이용자는 쿠키 설치에 대한 선택권을 가지고 있습니다. 따라서 이용자는 웹브라우저에서 옵션을 설정함 으
로써 모든 쿠키를 허용하거나，쿠키가 저장될 때마다 확인을 거치거나，아니면 모든 쿠키의 저장을 거부 할
수도 있습니다.
...
1) 성명: 이수정
2) 직책: 프론트엔드 개발 리더
3) 전화번호: 010-5570-3676
4) 이메일: loodol99@gmail.com
제23조（개인정보의 열람청구를 접수·처리하는 부서）
1. 정보주체는 ｢개인정보 보호법｣ 제35조에 따른 개인정보의 열람 청구를 아래의 부서에 할 수 있습니다.
가. 개인정보 열람청구 접수·처리 부서
1) 부서명: 인프라 개발팀
2) 담당자: 김태형
3) 전화번호: 010-2024-2365제24조（권익침해에 대한 구제방법）
1. 정보주체는 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회，한국인터넷진흥원 개인 정
...
2. 회사는 정보주체의 개인정보자기결정권을 보장하고，개인정보침해로 인한 상담 및 피해 구제를 위해 노 력
하고 있으며，신고나 상담이 필요한 경우 제1항의 담당부서로 연락해주시기 바랍니다.
3. 개인정보 보호법 제35조（개인정보의 열람），제36조（개인정보의 정정•삭제），제37조（개인정보의 처리
정 지 등）의 규정에 의한 요구에 대 하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익
의 침 해를 받은 자는 행정 심판법 이 정하는 바에 따라 행정 심판을 청구할 수 있습니 다.
가. 중앙행정심판위원회 : （국번없이） 110 (www.simpan.go.kr)
부칙
제1조 본 방침은 2024.11.30.부터 시행됩니다.`;